...
public class Normalclassevaluatetables implements Serializable {
        ...
        private String steachercondition;
        /**课堂氛围*/
        private Integer classatomspere;
        private String sclassatomspere;
        /**学生情况*/
        private Integer studentscondition;
        private String sstudentscondition;

        private Integer playphone;
        private String splayphone;
        /**教材情况*/
        private Integer bookcondition;
        private String sbookcondition;
        /**抬头情况*/
        private Integer lookupcondition;
        private String slookupcondition;
        /**就坐情况*/
        private Integer sitecondition;
        private String ssitecondition;
        /**授课形式*/
        private Integer teachingshape;
        private String steachingshape;
    ...
    public String getSteachingshape() {
        return steachingshape;
    }

    public void setSteachingshape(String steachingshape) {
        this.steachingshape = steachingshape;
    }

    public String getSsitecondition() {
        return ssitecondition;
    }

    public void setSsitecondition(String ssitecondition) {
        this.ssitecondition = ssitecondition;
    }

    public String getSlookupcondition() {
        return slookupcondition;
    }

    public void setSlookupcondition(String slookupcondition) {
        this.slookupcondition = slookupcondition;
    }

    public String getSbookcondition() {
        return sbookcondition;
    }

    public void setSbookcondition(String sbookcondition) {
        this.sbookcondition = sbookcondition;
    }

    public String getSplayphone() {
        return splayphone;
    }

    public void setSplayphone(String splayphone) {
        this.splayphone = splayphone;

    }

    public String getSstudentscondition() {
        return sstudentscondition;
    }

    public void setSstudentscondition(String sstudentscondition) {
        this.sstudentscondition = sstudentscondition;
    }

    public String getSclassatomspere() {
        return sclassatomspere;
    }

    public void setSclassatomspere(String sclassatomspere) {
        this.sclassatomspere = sclassatomspere;
    }

    public String getSteachercondition() {
        return steachercondition;
    }

    public void setSteachercondition(String steachercondition) {
        this.steachercondition = steachercondition;
    }
}