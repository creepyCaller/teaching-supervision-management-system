...
public class BaseDao{
    ...
    private List<Object> getList(Class type, String sql, Object[] param) {
        QueryRunner qr = new QueryRunner(MysqlTool.getDataSource());
        List<Object> list = new LinkedList<>();
        try {
    ...
    private List<Object> getList(Connection conn, Class type, String sql, Object[] param) {
        QueryRunner qr = new QueryRunner();
        List<Object> list = new LinkedList<>();
        try {
    ...
    private void updateTransaction(Connection conn, String sql, Object[] param) throws SQLException {
        QueryRunner qr = new QueryRunner();
...
//			MysqlTool.close(ps);
    ...
    private void insertBatch(String sql, Object[][] param) {
