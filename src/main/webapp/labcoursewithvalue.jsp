		...
		<table id="addTable" class="table table-border table-bordered table-striped" style="width: auto" cellpadding="8" align="center">
			...
			<tr>
				...
				<td width="350" height="70">
					<input class="easyui-slider" id="t1" name="t1" value="0" style="width:328px;" data-options="showTip:true,rule:[0,'|',3,'|',6,'|',9,'|',12,'|',15]">
				</td>
			...
			<tr>
				...
				<td width="350" height="70">
					<input class="easyui-slider" id="t4" name="t4" value="0" style="width:328px;" data-options="showTip:true,rule:[0,'|',2,'|',4,'|',6,'|',8,'|',10]">
				</td>
			</tr>
			<tr>
				<td width="200" height="70">5.遵守教学与课堂纪律，上课通信工具关闭，不迟到早退，准时上下课</td>
				<td width="350" height="70">
					<input class="easyui-slider" id="t5" name="t5" value="0" style="width:328px;" data-options="showTip:true,rule:[0,'|',2,'|',4,'|',6,'|',8,'|',10]">
				</td>
			...
			<tr>
				...
				<td width="350" height="70">
					<input class="easyui-slider" id="t8" name="t8" value="0" style="width:328px;" data-options="showTip:true,rule:[0,'|',5,'|',10,'|',15,'|',20]">
				</td>
			</tr>
