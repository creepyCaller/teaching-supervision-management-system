...
<head>
	...
	<script type="text/javascript" src="easyui/js/jquery.formLocalStorage.js"></script>
	<style type="text/css">
								...
								$.ajax({
									...
									success: function (msg) {
										if (msg == "success") {
											...
											$("#add_labmgrlevel").textbox('setValue', 0);
										} else {
...
<div id="planDialog" style="padding: 20px;width: auto;">
	<form id="commentForm" method="post">
		<table id="addTable" class="table table-border table-bordered table-striped" style="width: auto" cellpadding="8" >
			<tr>
			...
			<tr>
				...
				<td width="350">
					<input id="add_time" style="width: 150px; height: 30px;" class="easyui-datebox" type="text" name="etime" data-options="required:true, missingMessage:'请选择授课日期', editable:false" />
					<input id="add_lessonno"  class="easyui-textbox" style="width: 150px; height: 30px;" type="text" name="lessonno"  data-options="required:true, missingMessage:'请输入授课节次,示例：1-2'" />
					节
				</td>
			</tr>
			<tr>
