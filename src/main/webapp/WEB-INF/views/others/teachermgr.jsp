	...
	<script type="text/javascript">
		$(function() {
			...
			$('#dataList').datagrid({
				...
				fit: true,//自动大小
				method: "post",
				url:"TeacherController?method=TeacherList&t="+new Date().getTime(),
				idField:'id',
			...
			$("#delete").click(function(){
				...
				if(selectLength == 0){
					...
					$.messager.confirm("", "将删除教师，确认继续?", function(r){
						if(r){
							$.ajax({
								type: "post",
								url: "TeacherController?method=DeleteTeacher",
								data: {ids: ids},
				...
				buttons: [
					{
						...
						handler:function()
						{
							...
							else
							{
								$.ajax({
									type: "post",
									url: "TeacherController?method=AddTeacher",
				...
				buttons: [
					{
						...
						handler:function(){
							...
							else
							{
								$.ajax({
									type: "post",
									url: "TeacherController?method=EditTeacher",
...
<div id="addDialog" style="padding: 10px">
	<form id="addForm" method="post">
		<table cellpadding="8" >
			...
			<tr>
				<td>姓名:</td>
				<td><input id="add_teachername" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="teachername" data-options="required:true, missingMessage:'请填写姓名'" /></td>
			</tr>
		</table>
	</form>
</div>
...
<div id="editDialog" style="padding: 10px">
	<form id="editForm" method="post">
		<table cellpadding="8" >
			...
			<tr>
				<td>姓名:</td>
				<td><input id="edit_teachername" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="teachername" data-options="required:true, missingMessage:'请填写姓名'" /></td>
			</tr>
		</table>
