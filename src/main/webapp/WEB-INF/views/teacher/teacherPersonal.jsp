	...
	$(function() {	
		...
		$("#systemTable a").each(function(){
			$(this).click(function(){
				...
				$.ajax({
					type: "post",
					url: "SaveNameController?method=saveTeacherName&t="+new Date().getTime(),
					data: data,
					success: function(msg){
						if(msg == "success"){
				...
				<c:if test="${!result }">
					<table id="systemTable" class="table table-border table-bordered table-striped" style="width: auto" cellpadding="8" align="center">
						<tr>
							<td width="200">用户名:</td>
							<td width="350">
								<input value="${user.username}" class="easyui-textbox" style="width: 300px; height: 30px;" type="text" data-options="editable:false"/>
							</td>
						</tr>
						<tr>
							<td width="200">姓名:</td>
							<td width="350">
								<input value="${user.teachername}" class="easyui-textbox" style="width: 300px; height: 30px;" type="text" data-options="editable:false"/>
							</td>
						</tr>
						<tr>
							<td width="200">注册时间:</td>
						...
						<tr>
							<td width="200">用户类型:</td>
							<td width="350">
								<input value="${user.type}" class="easyui-textbox" style="width: 300px; height: 30px;" type="text" data-options="editable:false"/>
							</td>
						</tr>
					</table>
				</c:if>
